...
import 'package:book_application1/model/with%20hive/favorate_book.dart';
import 'package:book_application1/model/with%20hive/favorate_book_details.dart';
...
void main() async {
  ...
  Hive.registerAdapter(FavBookAdapter());
  Hive.registerAdapter(FavBookDetailsAdapter());

  await Hive.openBox<FavBookAdapter>('favoritesBox');
  await Hive.openBox<FavBookDetailsAdapter>('detailsBox');
